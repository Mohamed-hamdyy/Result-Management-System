...
import 'package:rms_app/models/response2.dart';
import 'package:rms_app/models/student_model.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';


class AdminRemoveCourse extends StatefulWidget {
  const AdminRemoveCourse({super.key, required this.title});
  ...
  @override
  State<AdminRemoveCourse> createState() => _AdminRemoveCourse();
}

class _AdminRemoveCourse extends State<AdminRemoveCourse> {
...
String a=IP().address;
var url ='http://$a:7000/RemoveCourse';
final body = {
...
var res = Response2.fromJson(json); 
if (res.done){
setState(() {
  add=true;
});
 ...
 decoration: const BoxDecoration(
         ...
         OutlinedButton(onPressed: ()async {
           if(_courseValue==null||_studentValue==null){
                ...
                add?'Course successfully removed from Student.'
