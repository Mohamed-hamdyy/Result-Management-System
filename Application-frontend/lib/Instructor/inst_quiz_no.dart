...
import 'package:rms_app/models/quizes_model.dart';
import '../Dialogs/dialogs.dart';
import 'inst_quiz.dart';

class InstQuizNo extends StatefulWidget {
  const InstQuizNo({super.key, required this.title,required this.courseVal});
  ...
  @override
  State<InstQuizNo> createState() => _InstQuizNo();
}

class _InstQuizNo extends State<InstQuizNo> {
...
String a=IP().address;
var url ='http://$a:7000/getCourseQuizApp2';
final body = {
'courseCode':widget.courseVal,
...
void _selectScreen(BuildContext ctx){
 ...
 MaterialPageRoute(builder: (_){
  return InstQuiz(title: 'Instructor', 
  courseVal:widget.courseVal,
   quizNum: _quizNo!,
    quizTotal: _totalController.text);
 }
 )
        ...
        child: Column(
          ...
          const Row(
            children: [
              ...
              Text('Select Quiz and  Add Total:',
      ...
      const SizedBox(height:15),
         ...
         SizedBox(
          ...
          const SizedBox(width:15),
            ...
            FutureBuilder<Quiz>(
               ...
               decoration: const BoxDecoration(
                ...
                value: _quizNo,
                items: quizes.n.map((s) => DropdownMenuItem<String>(
                  value:"$s",
                  child:  Text("[Quiz $s]",
          ...
          OutlinedButton(onPressed: (){
             if(_quizNo==null  || _totalController.text=="") {
    dialogs.informationI(context,"Invalid Input","please add the quiz total grade and the quiz number!");
